//-------------------------------------------------------------------------------
// <copyright file="DynamicExtensions.g.cs" company="frokonet.ch">
    ...
    internal class PrivateReflectionDynamicObject : DynamicObject
    {
        ...
        private IProperty GetProperty(string propertyName)
        {
            ...
            throw new ArgumentException(
                ...
                propertyName, this.RealObject.GetType(), String.Join(", ", propNames)));
        }
        ...
        [SuppressMessage("Microsoft.Globalization", "CA1304:SpecifyCultureInfo", MessageId = "System.Type.InvokeMember(System.String,System.Reflection.BindingFlags,System.Reflection.Binder,System.Object,System.Object[])", Justification = "Revised, okay.")]
